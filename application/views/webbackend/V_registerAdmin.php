...
<div class="login-box">
  <div class="login-logo">
    <a href="#"><b>PT PRODIA WIDYAHUSADA TBK</b></a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    <p class="login-box-msg">Register User</p>

    <form action="<?php echo base_url().'webbackend/C_dataOperator/prosesRegisterAdmin'?>" method="post" class="form-element" id="regisForm">
      <div class="form-group has-feedback">
        <input type="text" name="namaLengkap" class="form-control" placeholder="Nama Lengkap" id="namaLengkap">
      </div>
      <div class="form-group has-feedback">
        <input type="text" name="noTelepon" class="form-control" placeholder="No Telepon" id="noTelepon">
      </div>
      <div class="form-group has-feedback">
      ...
      <div class="row">
        <div class="col-6 text-center">
           <button type="button" onclick="registerUser();" class="btn btn-info btn-block btn-flat margin-top-10">REGISTER</button>
        </div>
        <div class="col-6 text-center">
           <?php echo anchor('webbackend/C_dataOperator/login','LOGIN',array('class'=>'btn btn-orange btn-block btn-flat margin-top-10' ));?> 
        </div>
        <!-- /.col -->
      </div>
    </form>
...
<script type="text/javascript">
  ...
  function registerUser(){
    ...
    if(namaLengkap == ''){
      valid = 0;
      var msg1 = 'Nama Lengkap Tidak Boleh Kosong';
      alert(msg1);
    }

    if(noTelepon == ''){
      valid = 0;
      var msg1 = 'No Telepon Tidak Boleh Kosong';
      alert(msg1);
    }

    if(username == ''){
      valid = 0;
      var msg1 = 'Username Tidak Boleh Kosong';
      alert(msg1);
    }

    if(password == ''){
      valid = 0;
      var msg1 = 'Password Tidak Boleh Kosong';
      alert(msg1);
    }
