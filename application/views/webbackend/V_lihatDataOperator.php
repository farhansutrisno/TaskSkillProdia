              ...
              <?php
                $no=1;
                  foreach ($operator as $key){
                      ...
                      ?>
                      <td>
                          <a href="<?php echo base_url().'webbackend/C_dataOperator/detailDataOperator/'.$key->idOperator?>" class="btn btn-info"> <i class="ion ion-md-eye"></i> Detail</a>
                          <a href="<?php echo base_url().'webbackend/C_dataOperator/updateDataOperator/'.$key->idOperator?>" class="btn btn-primary">
                          <i class="ion ion-md-create"></i> Edit</a>
                          <!-- <a href="<?php echo base_url().'webbackend/C_dataOperator/deleteDataOperator/'.$key->idOperator?>" class="btn btn-danger"><i class="ion ion-md-trash"></i> Delete</a> -->
                      </td>
                  </tr>
                <?php } ?> 
