     ...
     <!-- Basic Forms -->
      <div class="box box-default">
        ...
        <div class="box-body">
          <div class="row">
            <div class="col-6">
              <div class="table-responsive">
                ...
                <!-- <tr><th>Kd Operator</th><td><?php echo $row[0]->idOperator?></td></tr> -->
                <tr><th>Nama Lengkap</th><td><?php echo $row[0]->namaLengkap ?></td></tr>
                <tr><th>Username</th><td><?php echo $row[0]->username ?></td></tr>
                <tr><th>Password</th><td><?php echo $row[0]->password ?></td></tr>
                <tr><th>Tanggal Lahir</th><td><?php $date=date_create($row[0]->tanggalLahir); echo date_format($date,"d-M-Y"); ?></td></tr>
              </table>
              </div>
            </div>
            <div class="col-6">
              <div class="table-responsive">
                ...
                <tr><th>Foto</th><td><img src="<?php echo base_url().'gambar_proyek/'.$row[0]->foto ?>" width="150px" height="150px"></td></tr>
              </table>
              </div>
          ...
          <br>
           <?php echo anchor('webbackend/C_dataOperator/lihatDataOperator','B A C K',array('class'=>'btn btn-round btn-info'));?>
          <!-- /.row -->
        </div>
        <!-- /.box-body -->
      </div>
