...
<div class="wrapper">
      ...
      <div class="box box-default">
        ...
        <div class="box-body">
          <div class="row">
            <div class="col-4">
              <div class="table-responsive">
                ...
                <tr><th width="100px">Daerah</th><td><?= $cuaca['name'].' - '.$cuaca['sys']['country'] ?></td></tr>
                <tr><th width="100px">Latitude</th><td><?= $cuaca['coord']['lat'] ?></td></tr>
                <tr><th width="100px">Longitude</th><td><?= $cuaca['coord']['lon'] ?></td></tr>
                <tr><th width="100px">Timezone</th><td><?php  
            ...
            <div class="col-4">
              <div class="table-responsive">
                <table class="table table-bordered">
                <tr><th width="150px">Pressure</th><td><?= $cuaca['main']['pressure'] ?> hPa</td></tr>
                <tr><th width="150px">Humidity</th><td><?= $cuaca['main']['humidity'] ?></td></tr>
                <tr><th width="150px">Wind Speed</th><td><?= $cuaca['wind']['speed'] ?> Meter/Sec</td></tr>
              </table>
              </div>
            </div>
            </div>
          ...
          <div class="box-body">
           ...
           <?php echo anchor('webbackend/C_dataOperator/lihatDataCuaca','B A C K',array('class'=>'btn btn-round btn-info'));?>
           <br>
          <!-- /.row -->
        </div>
        <!-- /.box-body -->
  ...
  <footer class="main-footer">
    ...
    </div>Copyright &copy; Farhan Sutrisno 2022 All Rights Reserved.
  </footer>
