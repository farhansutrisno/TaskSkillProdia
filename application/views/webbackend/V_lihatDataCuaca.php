          ...
          <div class="box">
            <div class="box-body">
                <div>
                  ...
                  <form action="<?php echo base_url().'webbackend/C_dataOperator/prosesCekCuaca'?>" method="POST" id="regisForm">

                    <div class="row">
                      <div class="col-5">
                          <div class="form-group">
                            <h5>Masukan Nama Daerah</h5>
                            <div class="controls">
                              <input type="text" id="namaDaerah" name="namaDaerah" class="form-control" required>
                            </div>
                    ...
                    <div class="text-xs-right">
                      <fieldset>
                       <button type="button" onclick="saveregister();" class="btn btn-info btn-lg marleft20 active">C E K</button>
                      </fieldset>
                    </div>
...
<script type="text/javascript">
  ...
  function saveregister(){
    ...
    if(namaDaerah == ''){
      valid = 0;
      var msg1 = 'Nama Daerah Tidak Boleh Kosong';
    }
