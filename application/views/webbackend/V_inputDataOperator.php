...
<div class="wrapper">
     ...
     <!-- Basic Forms -->
      <div class="box box-default">
        ...
        <div class="box-body">
          ...
          <form method="POST" action="<?php echo base_url().'webbackend/C_dataOperator/prosesInputDataOperator'?>" enctype="multipart/form-data">
          ...
          <div class="form-group">
            <h5>Nama Lengkap</h5>
            <div class="controls">
              <input type="text" name="namaLengkap" class="form-control" value="<?php echo set_value('namaLengkap') ?>" required>
          ...
          <div class="form-group">
              <h5>Tanggal Lahir</h5>
              <div class="controls">
                  <input class="form-control datepicker" style="width:335px;" size="30" data-date-format="yyyy-mm-dd" type="text" name="tanggalLahir" value="<?php echo set_value('tanggalLahir') ?>" required> 
          ...
          <div class="text-xs-right">
            ...
            <h5>No Telepon</h5>
            <div class="controls">
              <input type="number" name="noTelepon" class="form-control" value="<?php echo set_value('noTelepon') ?>" required> 
  ...
  <footer class="main-footer">
    ...
    </div>Copyright &copy; Farhan Sutrisno 2021 All Rights Reserved.
  </footer>
