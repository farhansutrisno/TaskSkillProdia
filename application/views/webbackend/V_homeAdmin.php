          ...
          <div class="box">
            ...
            <div class="box-body">
              ...
              <a href="<?php echo base_url() ?>webbackend/C_dataOperator/lihatDataOperator" class="btn btn-app bg-purple">
                <i class="fa fa-user-o"></i> Data User
              </a>
              <a href="<?php echo base_url() ?>webbackend/C_dataOperator/lihatDataCuaca" class="btn btn-app bg-green">
                <i class="fa fa-server"></i> Web Page
              </a>
              <a href="<?php echo base_url() ?>webbackend/C_dataOperator/exportJson" class="btn btn-app bg-green" target="_blank">
                <i class="fa fa-server"></i> API Json
              </a>
