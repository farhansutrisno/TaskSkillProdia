...
<head>
  <meta charset="utf-8">
    ...
    <link rel="icon" href="<?php echo base_url() ?>frontend/img/logoprodia.png">

    <title>PT PRODIA WIDYAHUSADA TBK</title>
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="<?php echo base_url() ?>webbackend/C_dataOperator/homeAdmin" class="logo">
      ...
      <span class="logo-lg"><b>PT PRODIA WIDYAHUSADA TBK </b>Admin</span>
    </a>
    <!-- Header Navbar-->
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li>
          <a href="<?php echo base_url() ?>webbackend/C_dataOperator/lihatDataCuaca">
            <i class="fa fa-th"></i>
            <span>Web Page</span>
          </a>
        </li>
     ...
     <!-- Basic Forms -->
      <div class="box box-default">
        ...
        <div class="box-body">
          ...
          <input type="hidden" class="form-control" name="idOperator" value="<?php echo $operator[0]->idOperator?>" />

          <div class="form-group">
            <h5>Nama Lengkap</h5>
            <div class="controls">
              <input type="text" name="namaLengkap" value="<?php echo $operator[0]->namaLengkap ?>" class="form-control" required> 
            <?php echo form_error('namaLengkap'); ?></div>
          </div>

          <div class="form-group">
            <h5>Username</h5>
            <div class="controls">
              <input type="text" name="username" value="<?php echo $operator[0]->username ?>" class="form-control" required>
          ...
          <div class="form-group">
            <h5>Password</h5>
            <div class="controls">
              <input type="text" name="password" value="<?php echo $operator[0]->password ?>" class="form-control" required> 
         ...
         <div class="form-group">
              <h5>Tanggal Lahir</h5>
              <div class="controls">
                  <input class="form-control datepicker" style="width:335px;" size="30" data-date-format="yyyy-mm-dd" type="text" name="tanggalLahir" value="<?php echo $operator[0]->tanggalLahir ?>" > 
          ...
          <div class="form-group">
            <h5>No Telepon</h5>
            <div class="controls">
              <input type="number" name="noTelepon" value="<?php echo $operator[0]->noTelepon ?>" class="form-control" required> 
            <?php echo form_error('noTelepon'); ?></div>
          </div>

          <div class="form-group">
            <h5>Email</h5>
            <div class="controls">
              <input type="email" name="email" value="<?php echo $operator[0]->email ?>" class="form-control" required> 
            ...
            <div class="controls">
              <select class="form-control" type="text" name="jenisKelamin" required>
                  ...
                  foreach($listgender as $listgender) { ?>
                      <option value="<?php echo $listgender;?>" <?php if($listgender == $operator[0]->jenisKelamin) echo 'selected';?>><?php echo $listgender;?></option>
                  <?php } ?>
          ...
          <div class="form-group">
            <h5>Foto</h5>
            <div>
                <span><img src="<?php echo base_url().'gambar_proyek/'.$operator[0]->foto ?>" height="50px" width="60px" ></span>
