...
<div class="login-box">
  ...
  <div class="login-box-body">
    ...
    <form action="<?php echo base_url().'webbackend/C_dataOperator/prosesLoginAdmin'?>" method="post" class="form-element" id="regisForm">
      ...
      <div class="row">
        <div class="col-6 text-center">
          <button type="button" onclick="loginUser();" class="btn btn-info btn-block btn-flat margin-top-10">LOGIN</button>
        </div>
        <div class="col-6 text-center">
          <?php echo anchor('webbackend/C_dataOperator/register','REGISTER',array('class'=>'btn btn-orange btn-block btn-flat margin-top-10' ));?> 
        </div>
        <!-- /.col -->
      </div>
    </form>
